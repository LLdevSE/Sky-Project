...
function Header() {
    ...
    return (
        <header className="bg-gradient-to-r from-gray-800 to-gray-900 text-white shadow-md p-4 px-8 relative">
            ...
            <div
                className={`fixed top-0 right-0 h-full w-64 bg-gray-900 z-40 transform transition-transform duration-300 ease-in-out ${menuOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                <div className="p-6 space-y-6 text-lg font-medium flex flex-col items-start">
                    ...
                    <a href="#" onClick={toggleMenu} className="text-white hover:text-yellow-400">Home</a>
                    <a href="#" onClick={toggleMenu} className="text-white hover:text-yellow-400">Shop</a>
                    <a href="#" onClick={toggleMenu} className="text-white hover:text-yellow-400">About</a>
                    <a href="#" onClick={toggleMenu} className="text-white hover:text-yellow-400">Contact</a>
                </div>
            </div>
        </header>
    );
